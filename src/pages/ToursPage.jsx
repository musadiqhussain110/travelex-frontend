              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-2">
                    <Link
                      to={`/tours/${tour.id}`}
                      className="rounded-full border border-slate-200 bg-white px-3 py-2.5 text-center text-xs font-medium text-slate-800 transition-colors duration-300 hover:border-[#00AEEF] hover:text-[#00AEEF]"
                    >
                      View Details
                    </Link>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="rounded-[2rem] bg-white p-6 shadow-md shadow-slate-200/70 sm:p-8"> 
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-[#FF6B00] px-6 py-3 text-sm font-medium text-white transition-colors duration-300 hover:bg-[#00AEEF]"
              >
                <FaWhatsapp />
                Customize Tour
              </a>
