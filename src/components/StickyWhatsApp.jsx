...
const StickyWhatsApp = () => {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="group fixed bottom-5 right-5 z-[999] flex h-14 w-14 items-center justify-center overflow-hidden rounded-full bg-[#25D366] text-white shadow-2xl transition-all duration-300 hover:w-44 hover:justify-start hover:px-5"
