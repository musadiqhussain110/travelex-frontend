      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <form className="mt-8 grid gap-4">
              <input
                ...
                className="w-full rounded-[5px] border border-slate-200 bg-white px-5 py-4 text-sm font-semibold text-slate-900 outline-none transition focus:border-[#00AEEF]"
              />
              ...
              <select className="w-full rounded-[5px] border border-slate-200 bg-white px-5 py-4 text-sm font-semibold text-slate-500 outline-none transition focus:border-[#00AEEF]">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-[5px] border border-slate-200 bg-white px-5 py-4 text-sm font-semibold text-slate-900 outline-none transition focus:border-[#00AEEF]"
              />
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center rounded-[5px] border border-slate-200 bg-white px-6 py-4 text-sm font-semibold text-slate-900 transition-colors duration-300 hover:border-[#00AEEF] hover:text-[#00AEEF]"
              >
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-[5px] shadow-2xl">
              <img
            ...
            <div className="absolute left-4 right-4 top-1/2 -translate-y-1/2 rounded-[5px] bg-[#FF6B00] p-6 text-white shadow-2xl sm:left-10 sm:right-auto sm:w-[360px] sm:p-8">
              <h3 className="text-2xl font-medium">TravelEx Air Service</h3>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-7 inline-flex items-center justify-center gap-2 rounded-[5px] bg-white px-5 py-3 text-sm font-semibold text-slate-950 transition-colors duration-300 hover:bg-[#00AEEF] hover:text-white"
              >
                <FaWhatsapp />
